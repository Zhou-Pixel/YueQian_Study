/*
 * @Author: ZhouGuiqing
 * @Date: 2021-08-16 15:16:54
 * @LastEditTime: 2021-08-17 14:50:58
 * @LastEditors: ZhouGuiqing
 * @Description: 
 * @FilePath: \code\Experiment\IO\exp7\lib\showbmp.c
 */
/*
 * @Author: ZhouGuiqing
 * @Date: 2021-08-12 16:33:09
 * @LastEditTime: 2021-08-16 16:46:29
 * @LastEditors: ZhouGuiqing
 * @Description:自动缩放和居中显示bmp图片 
 * @FilePath: \YueQian\code\Experiment\IO\exp7\lib\showbmp.c
 */
#include "showerror.h"
#include "bmp.h"

int showimg(const char *bmp)
{
