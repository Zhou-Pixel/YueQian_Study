/*
 * @Author: ZhouGuiqing
 * @Date: 2021-08-12 17:01:45
 * @LastEditTime: 2021-08-17 14:51:10
 * @LastEditors: ZhouGuiqing
 * @Description: 
 * @FilePath: \code\Experiment\IO\exp7\lib\showjpeg.c
 */
/*
 * @Author: ZhouGuiqing
 * @Date: 2021-08-10 15:54:40
 * @LastEditTime: 2021-08-12 18:47:39
 * @LastEditors: ZhouGuiqing
...
int showimg(const char *jpeg)
{
    ...
    char *mm_lcd = mmap(NULL, 800*480*4, PROT_WRITE|PROT_READ, MAP_SHARED, lcd_fd, 0);
